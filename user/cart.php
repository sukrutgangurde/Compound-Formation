...
if(empty($_SESSION['cart']))
{
	...
	?>
	<div class="text-center" style="background-color:black; color:white; height:calc(100vh - 50px);">
		<img src="../images/cart-empty.png">
		<h4>Your cart is <span style="color:#ec7205;">Empty</span>..!</h4><br>
		<a href="index.php" class="btn btn-success">Add Products</a>
	</div>
	...
	<div id="page-wrapper">
		...
		if(isset($_SESSION['cart']))
		{
			...
			$result = mysqli_query($conn,$sql);
				...
				{ ?>
						...
						<table class="table center" style="margin-top:50px;">
		...
		<?php	} ?>
				...
				<div class="text-center">
					<a href="index.php" class='btn btn-primary shadow'>Add Product</a>
					<a href="checkout.php"class='btn btn-warning shadow' name='sbtn'>Proceed to buy</a>
