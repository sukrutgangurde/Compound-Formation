...
async function initialize() {
    ...
    const { id, clientSecret } = await fetch("payment_init.php?payid="+payid, {
        method: "POST",
...
async function handleSubmit(e) {
    ...
    const { id, customer_id } = await fetch("payment_init.php?payid="+payid, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
    ...
    if (paymentIntent) {
        switch (paymentIntent.status) { 
            case "succeeded":
                ...
                fetch("payment_init.php?payid="+payid, {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
